...
#ifndef PROJECT_BUNNY_H
#define PROJECT_BUNNY_H

HittableList bunny_scene() {
...
SimpleCamera bunny_camera(double aspect_ratio) {
    // basic settings
...
ConstantSkybox bunny_skybox() { return {}; }

#endif //PROJECT_BUNNY_H
